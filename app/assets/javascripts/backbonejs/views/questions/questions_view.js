...
ICR360App.QuestionView = Backbone.Marionette.ItemView.extend({
  template: jade.templates['question_view'],
  tagName: "div",
  className: "vendor",
  events: {
...
ICR360App.QuestionsView = Backbone.Marionette.CollectionView.extend({
  tagName: "div",
  className: "object_list",
  id: "vendors",
  itemView: ICR360App.QuestionView,
  ui: {
    inputRating: ":radio.rating",
